...
export async function GET(){
  ...
  try {
    ...
    console.error("[admin/general-monitors/export] provider failure", error instanceof Error ? error.name : "unknown");
    return new NextResponse("CSVを作成できませんでした",{status:503});
  }
}
