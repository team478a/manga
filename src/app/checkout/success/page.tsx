...
export default async function CheckoutSuccessPage({ searchParams }: { searchParams: Promise<{ session_id?: string }> }) {
  ...
  let message = "決済情報を確認しています。少し時間をおいて再読み込みしてください。";
  ...
  if (sessionId) {
    try {
      ...
      message = "決済情報を確認できませんでした。セッションIDを確認してください。";
    }
  }
  ...
  return (
    <main className="page max-w-2xl">
      <section className="panel text-center">
        ...
        {downloadUrl ? <a className="button mt-6 inline-flex" href={downloadUrl}>「{productTitle}」をダウンロード</a> : null}
