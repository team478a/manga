    ...
    <section className="space-y-5" aria-labelledby="longform-pages">
      ...
      <form action={startCloudPageGenerationBatchAction.bind(null, projectId)} className="panel" id="page-generation">
        ...
        <ol className="mt-4 grid gap-2 text-sm sm:grid-cols-3">
          ...
          <li className="rounded-lg border border-violet-100 bg-violet-50 p-3"><strong>2. 見積りを確認</strong><p className="mt-1 text-xs text-stone-600">必要credit、人物・画風、停止理由を確認します。</p></li>
          <li className="rounded-lg border border-violet-100 bg-violet-50 p-3"><strong>3. 紫のボタンで開始</strong><p className="mt-1 text-xs text-stone-600">選択したページの各コマだけを順番に生成します。</p></li>
        </ol>
