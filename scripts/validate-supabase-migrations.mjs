...
for (const required of [
  ...
  "cloud_adult_ai_planning_settings",
  "cloud_adult_ai_planning_consents",
  "can_use_cloud_adult_ai_planning",
  "cloud_adult_scenario_settings",
  "cloud_adult_scenario_consents",
  "can_use_cloud_adult_scenario",
  "cloud_adult_storyboard_settings",
  "cloud_adult_storyboard_consents",
  "can_use_cloud_adult_storyboard",
  ...
  "cloud_adult_grok_settings",
  "cloud_adult_grok_audit_logs",
  "set_cloud_adult_grok_provider",
  "get_cloud_adult_grok_runtime_config",
  "cloud_adult_monitor_enrollments",
  "cloud_adult_monitor_feedback",
