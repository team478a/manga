...
| 優先 | タスク                        | 現在の制限                                                                            |
| ---- | ----------------------------- | ------------------------------------------------------------------------------------- |
| P0   | ハイブリッド生成Phase 1基盤   | Router・作品ポリシー・ローカル実行ゲート・Asset Library・safe素材Job routeまで完了    |
| P1   | safe Jobのローカル生成handoff | Library不一致時の判定はlocalになるが、safe Job条件をComfyUIフォームへ引き継いでいない |
