...
2026-07-24の保守性改善Phase 0を開始し、PR-01としてMarketplace Storageの所有者Policy、新規保存path、旧path互換、RLS試験まで完了しました。次はPR-02としてcanonical `schema.sql`の無条件`content_class`更新を除去し、二重適用時に既存データが変化しないことを固定します。
