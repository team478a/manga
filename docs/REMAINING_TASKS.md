...
2026-07-24の保守性改善はPR-01からPR-20まで完了し、Storage所有者制限、schema冪等化、Cloud AI補償、upload制限、streaming、Canvas保存回復、Worker lease、CI、主要モジュール分割、依存境界、主要Cloud／Checkout／Billing／Desktop連携の型付きErrorへ対応しました。次はStripe Webhook、購入download、残るHub Server ActionのError契約とStructured Loggingを段階移行します。
