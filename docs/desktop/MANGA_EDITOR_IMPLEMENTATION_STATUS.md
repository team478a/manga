...
| 7   | 素材画像をコマへ配置                  | 完了         | 選択素材割り当て。直接D&Dは未実装                  |
...
| 11  | 吹き出しへテキスト入力                | 完了         | 親Balloon指定と本文入力。自動生成は未実装          |
...
| 30  | 今回追加したテスト                    | 完了         | canvas-core 12/12、Canvas DB・書き出し試験成功     |
...
2. 素材からコマへの直接D&D
3. ドラッグ式コマ作成とグリッド・スナップ切替
4. Canvas内画像編集専用モード
5. 吹き出しと子テキストの自動作成・相対座標・追従
6. レイヤーD&D並び替え
7. 30オブジェクトPage性能確認
8. クリーンWindowsへのインストール確認
