...
- 日本語・英語locale基盤と漫画編集workspace・Creator Chat・画像生成・設定・更新・Hub連携の英語表示、dialog focus管理、reduced motion、Windows forced colorsに対応しています。main process messageの翻訳とWCAG評価は未完了です。
