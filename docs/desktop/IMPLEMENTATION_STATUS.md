...
- 日本語・英語locale基盤と漫画編集workspace・Creator Chat・画像生成・AI接続診断・診断データ/プライバシーの英語表示、dialog focus管理、reduced motion、Windows forced colorsに対応しています。Hub・設定残画面の翻訳とWCAG評価は未完了です。
