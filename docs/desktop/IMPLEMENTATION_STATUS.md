...
- 日本語・英語locale基盤と漫画編集workspace・Creator Chat・画像生成・設定・更新・Hub連携の英語表示、dialog focus管理、reduced motion、Windows forced colorsに対応しています。製品Electronを使うHomeのaxe A・AA監査は20項目合格・違反0件です。main process messageの翻訳、他画面の自動評価、Narrator確認は未完了です。
