...
- 日本語・英語locale基盤と漫画編集workspace・Creator Chat・画像生成・設定・更新・Hub連携の英語表示、dialog focus管理、reduced motion、Windows forced colorsに対応しています。製品Electronを使う主要9画面・状態のaxe A・AA監査は合計195項目合格・違反0件です。装飾記号等の判定保留3件、main process messageの翻訳、生成状態・英語localeの自動評価、Narrator確認は未完了です。
