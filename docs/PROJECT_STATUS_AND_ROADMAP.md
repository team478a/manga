...
- 漫画編集workspace、Creator Chat、画像生成、書き出し、設定、更新、Hub連携の英語表示は対応済み。既知main process messageの英語変換と未知日本語文面fallbackも対応済み。日英20画面・状態のaxe A・AA監査は違反0件。画像生成の実行中・完了・失敗状態とNarrator確認は未完了
