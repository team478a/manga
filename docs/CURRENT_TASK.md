...
- 状態: `IMPLEMENTED / LOCAL_VALIDATION_PASSED / DRAFT_PR_PENDING / REAL_AUTHORIZATION_NOT_CREATED / REAL_DISTRIBUTION_NOT_RUN / STAGE0_BLOCKED_EXTERNAL_PREREQUISITES / STAGE1_DISTRIBUTION_BLOCKED`
...
- 次: 実装をcommit・pushしDraft PRを作成する。全CI／Vercel Preview成功で停止し、実Stage 0と実Stage 1承認・配布は外部前提と対象付き明示承認を待つ。
