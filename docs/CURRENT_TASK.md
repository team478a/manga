...
- 状態: `IMPLEMENTED / LOCAL_GATES_PASSED / PRODUCTION_UNCHANGED / DRAFT_PR_PENDING`
...
- 次: 文書同期、commit、push、Draft PR、全CI、Vercel Previewを確認して停止する。merge前にProduction評価保存や有料画像生成を実行しない。
