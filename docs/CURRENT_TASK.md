...
- 状態: `IMPLEMENTED_LOCAL / MOBILE_OFFLINE_PACKAGE_READY / SECURE_TRANSFER_PENDING / HUMAN_REVIEW_REQUIRED / FORMAL_COUNT_0`
- Draft PR: 作成・CI確認前
...
- 次: Draft PR、全CI／Vercel Preview成功を確認して停止する。安全な配布先とReviewer A/Bが決まるまで画像を外部送信せず、R4-3Bへ進まない。
