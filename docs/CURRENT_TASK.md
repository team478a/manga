...
- Production、DB、Provider実行、Job登録、Asset、Canvas、credit操作は0件。次: commit、push、Draft PRを作成し、全CI／Vercel Preview成功で停止する。実生成はmerge後も利用者の確認操作または別のProduction実行時明示承認を必要とする。
