...
- 状態: `IMPLEMENTED / LOCAL_VALIDATION_PASSED / COMMIT_PENDING / REAL_PROPOSAL_NOT_APPLIED / REAL_LEDGER_NOT_CHANGED / REAL_PILOT_OPERATION_NOT_RUN`
...
- Branch: `codex/adult-pilot-ledger-status-apply-20260917`。Implementation commit／Draft PRは作成前。
