...
- 状態: `IMPLEMENTED_LOCAL / DRAFT_PR_PENDING / ENCRYPTED_PACKAGES_READY / OUTBOUND_NOT_SHARED / HUMAN_REVIEW_REQUIRED / FORMAL_COUNT_0`
...
- 次: Draft PR、全CI、Vercel Preview成功で停止する。責任者が受取人と2つの共有経路を指定するまで外部送信せず、R4-3Bへ進まない。
