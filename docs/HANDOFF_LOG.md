...
- full `rc:validate`成功（Hub 632/632、Desktop 182/182、migration 52/52、Hub／Desktop production build）。クリーンworktree初回は共有package未buildで型検査開始前に失敗し、`build:packages`後の再実行で完走した。
