...
## 2026-07-31 Codex: 成人向け限定モニター運用基盤を統合

- 最新一般向け基盤へ成人向け市場分析から非公開作品管理までの既存stackと
  Grok Provider管理を統合した。
- 成人向け専用の招待文面、初回案内、利用者Webマニュアル、
  公開前readiness、スタッフ手順を追加した。
- 招待操作は全工程一括許可とメール送信を行い、再送と送信中表示に対応した。
- 成人向けフィードバックに未対応・対応中・対応済みと管理メモを追加した。
- 成人向け画像生成、作品公開、販売は対象外のまま維持した。
