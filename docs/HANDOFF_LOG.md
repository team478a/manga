...
- migrationは未適用。Production、Provider、生成、credit、利用者Project／画像を変更していない。集中4/4、Hub 1013/1013、Desktop 407/407、Canvas 26/26、AI 50/50、a11y 29画面blocking violation 0、deps error 0（既知warning 2件）、lint、typecheck、Hub／Desktop build、migration 84/84、RC構造、diff check成功。Draft PR作成後に全CI／Vercel Previewを確認する。
