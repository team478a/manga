...
- stacked Draft PRは [#89](https://github.com/team478a/manga/pull/89)。親はM1 Draft PR #88。
...
- deps、lint、Hub/Desktop typecheck、Hub 306/306、migration 31/31、production build、diff checkが成功した。
