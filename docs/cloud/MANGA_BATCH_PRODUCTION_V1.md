# MANGAI Cloud 4〜8ページ一括生成・編集ロック

作成日: 2026-08-01

## 目的

32ページ読切を一度に無人生成せず、利用者が4〜8ページを選んで生成を開始し、進捗を確認しながら停止・再開・中止・失敗分再実行できる制作単位を追加する。

## 実装

- 4〜8ページ、最大64コマに制限した一括生成
...
- Previewで4〜8ページを選び、開始・停止・再開・中止・失敗分再実行を確認する。
