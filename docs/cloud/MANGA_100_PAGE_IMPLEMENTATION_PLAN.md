...
進捗（2026-08-01）: `agent/manga-continuity-foundation-v1`で事実・伏線台帳と決定的矛盾検出を追加し、`agent/manga-continuity-suggestions-v1`で確定済みのキャラクター、場所・小物、シーン構成を確認候補へ変換した。次は作品コックピットとキャラクターarc・関係変化の時系列表示を統合する。
