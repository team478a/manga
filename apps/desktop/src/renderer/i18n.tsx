...
const ja = {
  ...
  "settings.adultSetup.registerWorkflows": "固定4方式を画像生成へ登録",
  "settings.adultSetup.workflowsRegistered": "固定4方式を登録しました（新規 {count} 件）。登録だけでは生成を開始しません。",
...
const en: Record<TranslationKey, string> = {
  ...
  "settings.adultSetup.registerWorkflows": "Register four fixed generation modes",
  "settings.adultSetup.workflowsRegistered": "The four fixed modes are registered ({count} new). Registration does not start generation.",
