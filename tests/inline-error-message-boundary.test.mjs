...
const pageContracts = [
  ...
  ["../src/app/checkout/[productId]/page.tsx", /<InlineErrorMessage>\{messages\.error\}<\/InlineErrorMessage>/],
...
test("Inline errorは既存のp要素とvisual classだけを共有する", async () => {
